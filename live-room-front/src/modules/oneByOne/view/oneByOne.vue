<template>
  <div class="page-container" :class="isPC?'':'mobile-css'">
    <div v-if="linkState !== 'idle'">
      <div flex="main:center" class="video-panel">
        <div @mousemove="mousemove" class="video-wrapper">
          <div flex="main:center cross:center" class="video-content local-video">
        ...
        <div class="chat-box">
          <div class="chat-wraper">
            <div class="chat-title p-10 b-b">与单纯的开始聊天</div>
